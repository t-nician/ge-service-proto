...
async def pre_launch():
    #primary_account_model  = await database_service.database_function.create_primary_account(
    #    authority_account_id="playfab_id",
    #    authority_account_type=account_service.account_app.PlatformAccountType.MORDHAU_ACCOUNT
    #)
    
    #discord_account = await database_service.database_function.create_platform_account(
    #    primary_account=primary_account_model,
    #    account_id="123424214",
    #    account_type=account_service.account_app.PlatformAccountType.DISCORD_ACCOUNT
    #)
    
    print(
        (await database_service.database_function.get_primary_account(
            "123424214",
            #account_service.account_app.PlatformAccountType.DISCORD_ACCOUNT
        )
